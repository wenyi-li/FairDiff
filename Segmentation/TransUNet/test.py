...
parser.add_argument('--datadir', type=str,
                    default='/DATA_EDS2/liwy/datasets/MedicalImage/data', help='root dir for validation volume data')  # for acdc volume_path=root_dir
...
if __name__ == "__main__":
    ...
    snapshot_path = "/DATA_EDS2/AIGC/2312/xuhr2312/workspace/FairSegDiff/model/{}/{}".format(args.exp, 'TU')
