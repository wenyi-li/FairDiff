...
parser.add_argument('--root_path', type=str,
                    default='/DATA_EDS2/liwy/datasets/MedicalImage/data', help='root dir for data')
...
parser.add_argument('--gamma', type=float,  default=1.0,
                    help='gamma')
parser.add_argument('--ckpt', type=str,  default="/DATA_EDS2/AIGC/2312/xuhr2312/workspace/FairSegDiff/model/TU_FairSeg224/TU_pretrain_ViT-B_16_skip0_epo300_bs16_224/epoch_299.pth",
                    help='checkpoint path(pretrained)')
