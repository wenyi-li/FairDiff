...
for epoch in 209 219 229 239 249 259 269 279 289 299; do
    LORA_CKPT+=( "/DATA_EDS2/AIGC/2312/xuhr2312/workspace/FairSegDiff/TransUNet/out/equal_scale_out/train_outputs/additional/${ATTRIBUTE}/TU_FairSeg224/TU_pretrain_ViT-B_16_skip0_epo300_bs48_lr0.02_224_${ATTRIBUTE}/epoch_${epoch}.pth" )
done
...
for (( j=0; j<${#EPOCH[@]}; j++ )); do
    CUDA_VISIBLE_DEVICES=6 python test_batch.py \
        --datadir ${BASE_DIR} \
        --output /DATA_EDS2/AIGC/2312/xuhr2312/workspace/FairSegDiff/TransUNet/out/equal_scale_out/test_outputs/${ATTRIBUTE} \
        --list_dir ${LIST_DIR} \
